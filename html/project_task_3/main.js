...
const story = `<h3>Story</h3> <p>A <span class="word" title="id: animal-1">${firstAnimal}</span> was making fun of the <span class="word" title="id: animal-2">${secondAnimal}</span> one day for being so slow.</p>
...
title.innerHTML = `<h1> The  <span class="word" title="id: animal-1"> ${firstAnimal}</span> And The  <span class="word" title="id: animal-2">${secondAnimal}</span> </h1>`;
...
moralMessage.innerHTML = `<span class="italics" title="id: message">"<h3>Moral:</h3> ${message}"</span>`;
